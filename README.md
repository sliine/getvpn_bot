...
Телеграм-бот для роздачі VPN-ключів. Перед тим як отримати ключ, користувач має підтвердити свій акаунт через номер телефону — приймаються тільки українські номери (+380). Всі дані пишуться в MySQL.
